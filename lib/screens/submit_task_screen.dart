...
class SubmitTaskScreen extends StatefulWidget {
  ...
  const SubmitTaskScreen({super.key, required this.token});
...
class _SubmitTaskScreenState extends State<SubmitTaskScreen> {
      ...
      await showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text(
              'Tugas berhasil dikirim ke server. Pastikan repository GitHub kamu sudah benar dan dapat diakses.',
  ...
  String? _validateGithubUrl(String? value) {
    if (value == null || value.trim().isEmpty) {
    ...
    if (!text.startsWith('https://github.com/')) {
      return 'Link harus berupa URL GitHub yang valid.';
    }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Lengkapi data produk dan link repository GitHub sebelum dikirim.',
            style: TextStyle(
              fontSize: 15,
              height: 1.5,
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Pastikan link GitHub diawali dengan https://github.com/ dan repository dapat diakses.',
              style: TextStyle(
                fontSize: 13.5,
